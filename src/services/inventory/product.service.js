  ...
  return await prisma.$transaction(async (tx) => {
    ...
    const product = await tx.product.create({
      data: {
        ...
        unitId: (data.unitId && data.unitId !== 'none') ? data.unitId : null,
  ...
  return await prisma.$transaction(async (tx) => {
    ...
    const updated = await tx.product.update({
      ...
      data: {
        ...
        categoryId: data.categoryId !== undefined ? (data.categoryId === '' || data.categoryId === 'none' ? null : data.categoryId) : product.categoryId,
        brandId: data.brandId !== undefined ? (data.brandId === '' || data.brandId === 'none' ? null : data.brandId) : product.brandId,
        unitId: data.unitId !== undefined ? (data.unitId === '' || data.unitId === 'none' ? null : data.unitId) : product.unitId,
